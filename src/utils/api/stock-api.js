...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=${"chpi0khr01qrhm8qg3j0chpi0khr01qrhm8qg3jg"}`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=${"chpi0khr01qrhm8qg3j0chpi0khr01qrhm8qg3jg"}`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=${"chpi0khr01qrhm8qg3j0chpi0khr01qrhm8qg3jg"}`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=${"chpi0khr01qrhm8qg3j0chpi0khr01qrhm8qg3jg"}`;
  const response = await fetch(url);
